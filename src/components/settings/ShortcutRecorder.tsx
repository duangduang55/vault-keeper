...
export function ShortcutRecorder({ value, onChange }: ShortcutRecorderProps) {
  ...
  return (
    <input
      ...
      onKeyUp={handleKeyUp}
      readOnly
      className={`flex-1 bg-surface-800 border rounded px-3 py-2 text-sm text-surface-200 placeholder-surface-500 focus:outline-none focus:ring-2 font-mono cursor-pointer transition-all duration-200
