        ...
        {configLoaded && (
          <div className="pt-1">
            ...
            <select
              ...
              className="w-full bg-surface-800 border border-surface-600/50 rounded px-3 py-2 text-sm text-surface-200 focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-all duration-200"
            >
